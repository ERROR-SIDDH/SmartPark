        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-2">
                <Input
                    ...
                    className="flex-1"
                />
                <Button variant="outline" onClick={searchByText} disabled={loading}>
                    <Search className="h-4 w-4" />
                </Button>
                <Button onClick={findNearby} disabled={locating} className="bg-gradient-to-r from-chart-2 to-primary hover:opacity-90">
                            ...
                            <CardContent className="p-5">
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-lg group-hover:text-primary transition-colors">{r.name}</h3>
